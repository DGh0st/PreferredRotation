#include "PRRootListController.h"

@implementation PRRootListController
...
- (void)email {
	if ([MFMailComposeViewController canSendMail]) {
		...
		[email setSubject:@"PreferredRotation Support"];
		[email setToRecipients:[NSArray arrayWithObjects:@"deeppwnage@yahoo.com", nil]];
		[email addAttachmentData:[NSData dataWithContentsOfFile:@"/var/mobile/Library/Preferences/com.dgh0st.preferredrotation.plist"] mimeType:@"application/xml" fileName:@"Prefs.plist"];
